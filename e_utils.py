...
dirs = {
    'train': 'data/COVID-19_Radiography_Dataset/etrain',
    'val': 'data/COVID-19_Radiography_Dataset/eval',
    'test': 'data/COVID-19_Radiography_Dataset/etest'
}
...
def get_results(confmat, classes):
    ...
    for i, l in enumerate(classes):
        ...
        results[l] = ['accuracy : ' + str(accuracy),'recall : ' + str(recall), 'precision : ' + str(precision),'f1score : ' + str(f1score)]
...
def fit(epochs, model, criterion, optimizer, train_dl, valid_dl):
    ...
    len_train, len_valid = 46930, 3260
    fields = [
    ...
    with open(f'outputs/CSVs/e_{model_name}.csv', 'w') as csv_file:
