...
def plot_summary(path):
    ...
    plt.tight_layout()
    fig.savefig(f'/content/gdrive/MyDrive/xrays-and-gradcam-master/outputs/summary_plots/{filename}.png')
    plt.show()
    plt.close()
...
def plot_confmat(train_mat, test_mat, classes, filename):
    ...
    plt.tight_layout()
    fig.savefig(f'/content/gdrive/MyDrive/xrays-and-gradcam-master/outputs/confusion_matrices/{filename}')
    plt.show()
    plt.close()
...
def plot_gradcam(image, vgg_cam, res_cam, dense_cam):
    ...
    plt.tight_layout()
    fig.savefig('/content/gdrive/MyDrive/xrays-and-gradcam-master/outputs/grad_cam.png')
    plt.show()
    plt.close()
