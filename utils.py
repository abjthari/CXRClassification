...
dirs = {
    'train': '/content/gdrive/MyDrive/xrays-and-gradcam-master/data/COVID-19_Radiography_Dataset/train',
    'val': '/content/gdrive/MyDrive/xrays-and-gradcam-master/data/COVID-19_Radiography_Dataset/val',
    'test': '/content/gdrive/MyDrive/xrays-and-gradcam-master/data/COVID-19_Radiography_Dataset/test'
}
    ...
    for epoch in range(epochs):
        ...
        with torch.no_grad():
            ...
            if valid_loss <= valid_loss_min:
                ...
                torch.save(
                    model.state_dict(),
                    f'/content/gdrive/MyDrive/xrays-and-gradcam-master/models/lr3e-5_{model_name}_{device}.pth'
                )
                valid_loss_min = valid_loss

    # write running results for plots
    with open(f'/content/gdrive/MyDrive/xrays-and-gradcam-master/outputs/CSVs/{model_name}.csv', 'w') as csv_file:
